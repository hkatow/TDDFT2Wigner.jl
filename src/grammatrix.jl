...
function grammatrix(wfn1::WFN,wfn2::WFN,salmon::SYSTEM,index1::Vector{Int64},index2::Vector{Int64})::ComplexF64
    ib1=index1[1]; ik1=index1[2]
    ib2=index2[1]; ik2=index2[2]
    nr=salmon.num_rgrid
    # alat=salmon.alat
    ...
    v=ComplexF64(0.0)    
    for ir3=1:nr[3],ir2=1:nr[2],ir1=1:nr[1]
        v+=conj(wfn1.orbital[ir1,ir2,ir3,ib1,ik1])*wfn2.orbital[ir1,ir2,ir3,ib2,ik2]
    end
    # v = v * dv
    return v
end